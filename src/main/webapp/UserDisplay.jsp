...
<body>
 ...
 <section style="height: 30px;background-color: pink;">
  ...
  <img src="img/pic2.jpg"/> User Profile Page
	  <br/>
	  <center>
<table style="width:70%; width-border:2px" border="1">

<tr>
<td>Sno</td>
<td>Username<a href="sortUsername"><img src="  img/sort-ascend.png"/></td>
<td>Role</td>
<td>Company Name</td>
<td>Email</td>
<td>City</td>
...
<c:forEach items="${userProfiles}" var="item" varStatus="hah">
<tr>
<td>${hah.count}</td>
<td>${item.username}</td>
<td>${item.role}</td>
...
<td>${item.city}</td>
<td>${item.title}</td>
<td><img src="findIMG?username=${item.username}" height="40px"></td>
...
<td><a href="${pageContext.request.contextPath}/mobile/editProfile?uid=${item.sno}"><img src="${pageContext.request.contextPath}img/edit.png"></a>
</tr>
</c:forEach>
</table>
